 ...
 */
function getQuoteUrl(translations) {
  const hostname = window.location.hostname;
 ...
 */
function initCalculator(lang = 'de', country = 'CH', allTranslations = null) {
  currentLang = lang;
